...
namespace ExcelExport
{
    public partial class Form1 : Form
    {
        ...
        Excel.Application xlApp; //Létrehozások 
        Excel.Workbook xlWB;
        ...
        private void CreateExcel()
        {
            ...
            xlApp = new Excel.Application(); //Értékadások
            xlWB = xlApp.Workbooks.Add();
            xlSheet = xlWB.ActiveSheet;
            CreateTable();
            xlApp.Visible = true;
            xlApp.UserControl = true; // A felhasználó tudja kezelni a táblát, 
            }
            catch (Exception ex)
            {
        ...
        private void CreateTable()
        {
            ...
            tableRange.BorderAround2(Excel.XlLineStyle.xlDashDotDot, Excel.XlBorderWeight.xlThick);
